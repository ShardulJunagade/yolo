...
results = model.train(
    data="/home/shardul.junagade/my-work/domain-adaptation-brick-kilns/yolo/yamls/delhi_to_wb.yaml",  # Path to the dataset YAML file
    epochs=100,
    imgsz=2560,
    batch=8,
    iou=0.33,
...
# nohup python ./yolo_train.py > ./logs/delhi_to_wb.log 2>&1 &